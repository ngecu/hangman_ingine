...
const wordLists = {
	...
	'Spanish': {
	  easy: ['hola', 'gracias', 'buenos días', 'buenas noches'],
	  medium: ['España', 'aprender', 'familia'],
	  hard: ['amigo', 'comida', 'cultura']
	},
	'English': {
	  easy: ['hello', 'thank you', 'good morning', 'good night'],
	  medium: ['United States', 'learn', 'family'],
	  hard: ['friend', 'food', 'culture']
	},
	'Hindi': {
	  easy: ['नमस्ते', 'धन्यवाद', 'सुप्रभात', 'शुभ रात्रि'],
	  medium: ['भारत', 'सीखें', 'परिवार'],
	  hard: ['दोस्त', 'खाना', 'संस्कृति']
	},
	'Arabic': {
	  easy: ['مرحبا', 'شكرا', 'صباح الخير', 'تصبح على خير'],
	  medium: ['المملكة العربية السعودية', 'تعلم', 'عائلة'],
	  hard: ['صديق', 'طعام', 'ثقافة']
	},
	'Bengali': {
	  easy: ['হাই', 'ধন্যবাদ', 'সুপ্রভাত', 'শুভ রাত্রি'],
	  medium: ['বাংলাদেশ', 'শেখা', 'পরিবার'],
	  hard: ['বন্ধু', 'খাবার', 'সংস্কৃতি']
	},
	'Portuguese': {
	  easy: ['olá', 'obrigado', 'bom dia', 'boa noite'],
	  medium: ['Brasil', 'aprender', 'família'],
	  hard: ['amigo', 'comida', 'cultura']
	},
	'Russian': {
	  easy: ['привет', 'спасибо', 'доброе утро', 'спокойной ночи'],
	  medium: ['Россия', 'учиться', 'семья'],
	  hard: ['друг', 'еда', 'культура']
	},
	'Japanese': {
	  easy: ['こんにちは', 'ありがとう', 'おはようございます', 'おやすみなさい'],
	  medium: ['日本', '学ぶ', '家族'],
	  hard: ['友達', '食べ物', '文化']
	},
	'Punjabi': {
	  easy: ['ਸਤ ਸ੍ਰੀ ਅਕਾਲ', 'ਧੰਨਵਾਦ', 'ਸਵੇਰ', 'ਸ਼ਾਮ'],
	  medium: ['ਭਾਰਤ', 'ਸਿੱਖਿਆ', 'ਪਰਿਵਾਰ'],
	  hard: ['ਦੋਸਤ', 'ਖਾਣਾ', 'ਸੰਸਕ੍ਰਿਤੀ']
	},
	'German': {
	  easy: ['hallo', 'danke', 'guten Morgen', 'gute Nacht'],
	  medium: ['Deutschland', 'lernen', 'Familie'],
	  hard: ['Freund', 'Essen', 'Kultur']
	},
	'Javanese': {
	  easy: ['halo', 'matur nuwun', 'sugeng enjang', 'sampun sugeng ndalu'],
	  medium: ['Indonesia', 'ngaji', 'keluarga'],
	  hard: ['teman', 'mangan', 'budaya']
	},
	'Wu (Shanghainese)': {
	  easy: ['侬好', '谢谢', '早晨好', '晚安'],
	  medium: ['中国', '学习', '家庭'],
	...
	'Telugu': {
	  easy: ['హలో', 'ధన్యవాదాలు', 'శుభోదయం', 'శుభారాత్రి'],
	  medium: ['భారతదేశం', 'నేర్చుకోవడం', 'కుటుంబం'],
	  hard: ['స్నేహితుడు', 'ఆహారం', 'సంస్కృతి']
	},
	'Vietnamese': {
	  easy: ['xin chào', 'cảm ơn', 'chào buổi sáng', 'chúc ngủ ngon'],
	  medium: ['Việt Nam', 'học', 'gia đình'],
	  hard: ['bạn bè', 'thức ăn', 'văn hóa']
	},
	'Marathi': {
	  easy: ['नमस्कार', 'धन्यवाद', 'सकाळी शुभेच्या', 'शुभ रात्री'],
	  medium: ['महाराष्ट्र', 'शिका', 'कुटुंब'],
	  hard: ['मित्र', 'जेवण', 'संस्कृती']
	},
	'French': {
	  easy: ['bonjour', 'merci', 'bonjour', 'bonne nuit'],
	  medium: ['France', 'apprendre', 'famille'],
	  hard: ['ami', 'nourriture', 'culture']
	},
	'Korean': {
	  easy: ['안녕하세요', '감사합니다', '좋은 아침', '안녕히 주무세요'],
	  medium: ['한국', '배우다', '가족'],
	  hard: ['친구', '음식', '문화']
	},
	'Tamil': {
	  easy: ['வணக்கம்', 'நன்றி', 'காலை வணக்கம்', 'இரவு நல்வரவு'],
	  medium: ['இந்தியா', 'கற்றுக்கொள்', 'குடும்பம்'],
	  hard: ['நண்பர்', 'உணவு', 'கலாச்சாரம்']
	},
	'Urdu': {
	  easy: ['ہیلو', 'شکریہ', 'صبح بخیر', 'شب بخیر'],
	  medium: ['پاکستان', 'سیکھنا', 'خاندان'],
	  hard: ['دوست', 'کھانا', 'ثقافت']
	}
  };
